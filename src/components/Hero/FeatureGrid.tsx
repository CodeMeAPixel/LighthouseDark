    ...
    <section className="mx-auto w-full max-w-6xl px-4 lg:px-8">
      ...
      >
        {features.map((f, i) => (
          ...
          >
            <div
              className={`${f.accent} mb-3 inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/30 p-2.5 text-light12 transition-all duration-300 dark:border-white/10 dark:bg-white/10 dark:text-dark12`}
            >
              {f.icon}
            </div>
