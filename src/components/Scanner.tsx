  ...
  return (
    ...
    >
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-light2 shadow-2xl dark:bg-dark2">
          <div className="flex h-10 items-center gap-2 border-b border-white/10 bg-light3 px-4 dark:bg-dark3">
            <div className="flex gap-1.5">
              <motion.div className="h-3 w-3 rounded-full bg-red-400/80" whileHover={{ scale: 1.2 }} />
              <motion.div className="h-3 w-3 rounded-full bg-amber-400/80" whileHover={{ scale: 1.2 }} />
              <motion.div className="h-3 w-3 rounded-full bg-green-400/80" whileHover={{ scale: 1.2 }} />
            </div>
      ...
      >
        ...
        <p className="text-sm font-medium text-light11 dark:text-dark11">{currentMessage.text}</p>
      </motion.div>
    </motion.div>
  )
}
