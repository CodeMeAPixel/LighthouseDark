	...
	return (
		<div className="relative flex min-h-[80vh] flex-col items-center justify-center px-4 py-16">
			...
			>
				...
				>
					...
					>
						...
						<div className="relative">
							<Flame
								className="h-24 w-24 text-red-500 drop-shadow-[0_0_40px_rgba(239,68,68,0.5)] md:h-32 md:w-32"
								strokeWidth={1.5}
							/>
							<motion.div
							...
							>
								<Flame
									className="h-24 w-24 text-orange-400/40 blur-sm md:h-32 md:w-32"
									strokeWidth={1.5}
								/>
							</motion.div>
					...
					<summary className="glass-surface group cursor-pointer rounded-xl p-4 transition-all hover:bg-white/10">
						<div className="flex items-center gap-3">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-light10 dark:text-dark10">
				...
				>
					Error ID:{" "}
					<code className="rounded bg-red-500/10 px-2 py-0.5 font-mono text-red-400">
						{errorId}
					</code>
				</motion.p>
			</motion.div>
