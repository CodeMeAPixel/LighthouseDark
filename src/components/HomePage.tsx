    ...
    <main className="relative min-h-screen pt-24 pb-32">
      <div className="relative z-10 mx-auto max-w-5xl px-6">
        ...
        >
          ...
          >
            Get instant performance insights, SEO analysis, and AI-powered recommendations 
            to make your website faster and more discoverable.
          </motion.p>
        </motion.div>
        ...
        {showLanding && (
          ...
          >
            <p className="text-sm text-light10 dark:text-dark10">
              Trusted by developers worldwide • Free forever • No sign-up required
            </p>
          </motion.div>
        )}
      </div>
