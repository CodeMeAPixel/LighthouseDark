...
const features = [
	{
		...
		description:
			"Get detailed Core Web Vitals and Lighthouse scores for both mobile and desktop devices.",
	},
	{
		icon: Target,
		title: "SEO Insights",
		description:
			"Analyze meta tags, Open Graph data, robots directives, and more for better search visibility.",
	},
	{
		icon: Sparkles,
		title: "AI Recommendations",
		description:
			"Receive personalized, actionable suggestions powered by GPT-4 to improve your website.",
	},
	{
		icon: Globe,
		title: "Real-World Testing",
		description:
			"Uses Google PageSpeed Insights API for accurate, real-world performance data.",
	},
];
			...
			<div className="relative z-10 mx-auto max-w-4xl px-6">
				...
				>
					...
					<p className="mx-auto max-w-2xl text-lg text-light11 dark:text-dark11">
						A modern web performance and SEO analysis tool designed to help
						developers and site owners understand and improve their websites.
					</p>
				</motion.div>
				...
				>
					<div className="flex items-start gap-4 mb-6">
						...
						<div>
							<h2 className="text-2xl font-semibold text-light12 dark:text-dark12 mb-2">
								Our Mission
							</h2>
							<p className="text-light11 dark:text-dark11">
								Lighthouse Dark was created with a simple goal: make web
								performance analysis accessible, beautiful, and actionable. We
								believe that every website deserves to be fast, and every
				...
				<motion.div
					...
					className="mb-8"
				>
					<h2 className="text-2xl font-semibold text-light12 dark:text-dark12 mb-6 text-center">
						What We Offer
					</h2>
				...
				>
					<h2 className="text-2xl font-semibold text-light12 dark:text-dark12 mb-6">
						Built With
					</h2>
				...
				>
					...
					<p className="mb-6 text-light11 dark:text-dark11 max-w-lg mx-auto">
						Lighthouse Dark is open source. We welcome contributions, bug
