...
const SITE_TITLE = 'Lighthouse Dark - The metrics Google is too polite to give you'
const SITE_DESCRIPTION = 'Get a blunt, witty critique of your website\'s SEO and Core Web Vitals with real data and actionable fixes. Free AI-powered performance analysis.'
...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { property: 'og:image:alt', content: 'Lighthouse Dark - The metrics Google is too polite to give you' },
      ...
      { name: 'twitter:image:alt', content: 'Lighthouse Dark - The metrics Google is too polite to give you' },
      ...
      // Copyright
      { name: 'copyright', content: `© ${new Date().getFullYear()} Lighthouse Dark. All Rights Reserved.` },
    ...
    links: [
      ...
      // Alternate formats
      { rel: 'alternate', type: 'application/rss+xml', href: '/feed.xml', title: 'Lighthouse Dark RSS Feed' },
      ...
      // Search
      { rel: 'search', type: 'application/opensearchdescription+xml', href: '/opensearch.xml', title: 'Lighthouse Dark' },
    ],
    scripts: [
